...
Подробнее — см. [ARCHITECTURE.ru.md](./ARCHITECTURE.ru.md).
...
Код бэкенда и комментарии — на английском. Тексты интерфейса фронтенда сейчас
на русском (контент продукта). Для международной аудитории их стоит вынести в
слой i18n (например, `next-intl`), а не хардкодить.
