...
`:t)===r){e.marks[e.pos]=A.CORRECT,e.pos++;const d=e.pos>=e.pattern.length;return d&&(e.finishedAt=Date.now()),{accepted:!0,wrong:!1,finished:d}}if(e.errors++,n)return{accepted:!1,wrong:!0,finished:!1};e.marks[e.pos]=A.WRONG,e.pos++;const i=e.pos>=e.pattern.length;return i&&(e.finishedAt=Date.now()),{accepted:!0,wrong:!0,finished:i}}function Yn(e){e.finishedAt===null&&e.pos>0&&(e.pos--,e.marks[e.pos]=A.PENDING)}function U(e){const t=e.finishedAt??Date.now(),n=e.startedAt?t-e.startedAt:0;let r=0;for(let l=0;l<e.pos;l++)e.marks[l]===A.CORRECT&&r++;const a=n/6e4,o=a>0?Math.round(r/5/a):0,i=r+e.errors,d=i>0?Math.round(r/i*100):100;return{typed:r,errors:e.errors,elapsedMs:n,wpm:o,accuracy:d}}const ln=[[{id:"tilde",u:1,en:"~",en2:"`",ru:"Ё"},{id:"d1",u:1,en:"1",en2:"!"},{id:"d2",u:1,en:"2",en2:"@"},{id:"d3",u:1,en:"3",en2:"#"},{id:"d4",u:1,en:"4",en2:"$"},{id:"d5",u:1,en:"5",en2:"%"},{id:"d6",u:1,en:"6",en2:"^"},{id:"d7",u:1,en:"7",en2:"&"},{id:"d8",u:1,en:"8",en2:"*"},{id:"d9",u:1,en:"9",en2:"("},{id:"d0",u:1,en:"0",en2:")"},{id:"minus",u:1,en:"-",en2:"_"},{id:"equal",u:1,en:"=",en2:"+"},{id:"backslash",u:1,en:"\\",en2:"|"},{id:"backspace",u:1.6,label:"←"}],[{id:"tab",u:1.5,label:"Tab"},{id:"q",u:1,en:"Q",ru:"Й"},{id:"w",u:1,en:"W",ru:"Ц"},{id:"e",u:1,en:"E",ru:"У"},{id:"r",u:1,en:"R",ru:"К"},{id:"t",u:1,en:"T",ru:"Е"},{id:"y",u:1,en:"Y",ru:"Н"},{id:"u",u:1,en:"U",ru:"Г"},{id:"i",u:1,en:"I",ru:"Ш"},{id:"o",u:1,en:"O",ru:"Щ"},{id:"p",u:1,en:"P",ru:"З"},{id:"lbracket",u:1,en:"[",en2:"{",ru:"Х"},{id:"rbracket",u:1,en:"]",en2:"}",ru:"Ъ"},{id:"enterpad2",u:1.45}],[{id:"caps",u:1.9,label:"Caps Lock"},{id:"a",u:1,en:"A",ru:"Ф"},{id:"s",u:1,en:"S",ru:"Ы"},{id:"d",u:1,en:"D",ru:"В"},{id:"f",u:1,en:"F",ru:"А"},{id:"g",u:1,en:"G",ru:"П"},{id:"h",u:1,en:"H",ru:"Р"},{id:"j",u:1,en:"J",ru:"О"},{id:"k",u:1,en:"K",ru:"Л"},{id:"l",u:1,en:"L",ru:"Д"},{id:"semi",u:1,en:";",en2:":",ru:"Ж"},{id:"quote",u:1,en:"'",en2:'"',ru:"Э"},{id:"enterpad3",u:1.45}],[{id:"lshift",u:2.3,label:"Shift"},{id:"z",u:1,en:"Z",ru:"Я"},{id:"x",u:1,en:"X",ru:"Ч"},{id:"c",u:1,en:"C",ru:"С"},{id:"v",u:1,en:"V",ru:"М"},{id:"b",u:1,en:"B",ru:"И"},{id:"n",u:1,en:"N",ru:"Т"},{id:"m",u:1,en:"M",ru:"Ь"},{id:"comma",u:1,en:",",en2:"<",ru:"Б"},{id:"period",u:1,en:".",en2:">",ru:"Ю"},{id:"slash",u:1,en:"/",en2:"?"},{id:"rshift",u:1.2,label:"Shift"},{id:"rept",u:1.2,label:"Rept"}],[{id:"lctrl",u:1.3,label:"Ctrl"},{id:"blank1",u:1.1},{id:"lalt",u:1.3,label:"Alt"},{id:"space",u:6.8,label:""},{id:"ralt",u:1.3,label:"Alt"},{id:"blank2",u:1.1},{id:"rctrl",u:1.3,label:"Ctrl"}]],cn=[["a","q"],["a","z"],["s","w"],["s","x"],["d","e"],["d","c"],["f","r"],["f","t"],["f","g"],["f","v"],["f","b"],["f","d5"],["j","y"],["j","u"],["j","h"],["j","n"],["j","m"],["j","d6"],["j","d7"],["k","i"],["k","comma"],["k","d8"],["l","o"],["l","period"],["semi","p"],["semi","lbracket"],["semi","rbracket"],["semi","quote"],["semi","slash"]],un={};for(const[e,t]of cn)un[t]=e;const mt=new Set(["tilde","d1","d2","d3","d4","d5","tab","q","w","e","r","t","caps","a","s","d","f","g","lshift","z","x","c","v","b"]),Xe=920,Ut=380,pt=12,Jt=6,Yt=60,Zn=70,Vn=14,_={};{ln.forEach((r,a)=>{const o=r.reduce((l,p)=>l+p.u,0),i=(Xe-2*pt-Jt*(r.length-1))/o;let d=pt;for(const l of r){const p=l.u*i;_[l.id]={...l,x:d,y:Vn+a*Zn,w:p,h:Yt},d+=p+Jt}});const e=_.enterpad2,t=_.enterpad3,n=Math.min(e.x,t.x);_.enter={id:"enter",u:0,label:"Enter",x:n,y:e.y,w:Xe-pt-n,h:t.y+Yt-e.y},delete _.enterpad2,delete _.enterpad3}const K={},B={};{const e=(t,n,r,a)=>{t[n]={id:r,shift:a}};for(const t of Object.values(_))t.en&&(/^[A-Z]$/.test(t.en)?(e(K,t.en.toLowerCase(),t.id,!1),e(K,t.en,t.id,!0)):(e(K,t.en,t.id,!1),t.en2&&e(K,t.en2,t.id,!0))),t.ru&&/^[А-ЯЁ]$/.test(t.ru)&&(e(B,t.ru.toLowerCase(),t.id,!1),e(B,t.ru,t.id,!0));e(B,".","slash",!1),e(B,",","slash",!0);for(const t of[K,B])e(t," ","space",!1),e(t,`
`,"enter",!1);for(const[t,n]of Object.entries(K))!(t in B)&&!/[a-zA-Z.,]/.test(t)&&(B[t]=n)}const dn={},pn={};for(const e of ln)for(const t of e)t.en&&t.ru&&/^[A-Z]$/.test(t.en)&&/^[А-ЯЁ]$/.test(t.ru)&&(dn[t.en.toLowerCase()]=t.ru.toLowerCase(),pn[t.ru.toLowerCase()]=t.en.toLowerCase());function Ce(e,t){if(e.length!==1||t.length!==1)return e;const n=e.toLowerCase();let r;return/[а-яё]/i.test(t)&&/[a-z]/.test(n)?r=dn[n]:/[a-z]/i.test(t)&&/[а-яё]/.test(n)&&(r=pn[n]),r?e===n?r:r.toUpperCase():e}function hn(e,t){return/[а-яё]/i.test(e)?B[e]??null:/[a-z]/i.test(e)?K[e]??null:(t?B[e]:K[e])??(t?K[e]:B[e])??null}function Et(e){const t=[];for(const n of Object.values(_)){const r=e==="en"?n.en:n.ru;r&&/^[A-Za-zА-Яа-яЁё]$/.test(r)&&t.push({id:n.id,ch:r.toLowerCase()})}return t}function ut(e,t){var n;return((n=hn(e,t))==null?void 0:n.id)??null}function Xn(e,t){return Et(e).filter(({id:n})=>t==="left"?mt.has(n):!mt.has(n)).map(({ch:n})=>n)}const Be=e=>e.replace(/[&<>"]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;"})[t]),bt=e=>e.x+e.w/2,gt=e=>e.y+e.h/2;function Qn(e,t){const n=bt(e),r=gt(e),a=bt(t),o=gt(t),i=(n+a)/2,d=(r+o)/2,l=a-n,p=o-r,u=Math.hypot(l,p)||1,m=Math.min(18,u*.18)*(l>=0?1:-1),j=i-p/u*m,de=d+l/u*m,Y=1-16/u,N=n+l*Y,Z=r+p*Y;return`M ${n.toFixed(1)} ${r.toFixed(1)} Q ${j.toFixed(1)} ${de.toFixed(1)} ${N.toFixed(1)} ${Z.toFixed(1)}`}function qe(e,t,n=!0,r=null){const a=e!==null?hn(e,t):null,o=(a==null?void 0:a.id)??null,i=o?un[o]??null:null;let d=null;a!=null&&a.shift&&o&&(d=mt.has(o)?"rshift":"lshift");const l=[];for(const u of Object.values(_)){const m=["key"];u.id===o&&m.push("key-next"),u.id===d&&m.push("key-shift"),u.id===i&&m.push("key-home");const j=(u.x+4).toFixed(1),de=u.y+3,Y=(u.w-8).toFixed(1),N=u.h-10;if(l.push(`<g class="${m.join(" ")}" data-key="${u.id}">`,`<rect class="key-base" x="${u.x}" y="${u.y}" width="${u.w.toFixed(1)}" height="${u.h}" rx="9"/>`,`<rect class="key-face" x="${j}" y="${de}" width="${Y}" height="${N}" rx="6"/>`),r&&u.id in r){const Z=r[u.id],Fn=Z<=0?"34,197,94":"217,58,58",zn=Z<=0?.22:(.2+.6*Math.min(Z,1)).toFixed(2);l.push(`<rect x="${j}" y="${de}" width="${Y}" height="${N}" rx="6" fill="rgb(${Fn})" opacity="${zn}"/>`)}u.label!==void 0?l.push(`<text class="key-fn" x="${bt(u).toFixed(1)}" y="${(gt(u)+4).toFixed(1)}" text-anchor="middle">${Be(u.label)}</text>`):(u.en2&&l.push(`<text class="key-en2" x="${(u.x+12).toFixed(1)}" y="${u.y+22}">${Be(u.en2)}</text>`),u.en&&l.push(`<text class="key-en" x="${(u.x+12).toFixed(1)}" y="${u.y+(u.en2?46:38)}">${Be(u.en)}</text>`),u.ru&&n&&l.push(`<text class="key-ru" x="${(u.x+u.w-12).toFixed(1)}" y="${u.y+u.h-14}" text-anchor="end">${Be(u.ru)}</text>`)),l.push("</g>")}const p=cn.map(([u,m])=>{const j=m===o&&u===(i??"");return`<path class="arr${j?" arr-active":""}" d="${Qn(_[u],_[m])}" marker-end="url(#arrhead${j?"-a":""})"/>`}).join("");return`<svg class="kbsvg${o?" has-target":""}" viewBox="0 0 ${Xe} ${Ut}" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Схема клавиатуры: красные стрелки — правильное направление движения пальцев от домашнего ряда">
    <defs>
...
`:e.key.length===1&&(t=e.key),t===null)return;e.preventDefault();const n=M.pattern[M.pos]??"";t=Ce(t,n);const r=ge(M,t,!0);r.wrong&&(ce++,me=Zt(bn()),kr()),r.finished&&(Lt+=M.pattern.length,me=Zt(mr()),Te+1<F.words.length?(br(),Te++,M=w([F.words[Te]])):vr()),_e()}function vr(){F&&(gr(),V=ce===0?3:1-ce/Math.max(Lt,1)>=.9?2:1,V>(ke.stars[F.id]??0)&&(ke.stars[F.id]=V,dr()),kt++,X="done")}function yt(e){F=e,Te=0,ce=0,Lt=0,me=e.lang==="ru"?s("k.startRu"):s("k.startEn"),M=w([e.words[0]]),X="level",_e()}const gn=e=>e.replace(/[&<>"]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;"})[t]);function wr(e){return e>0?"⭐".repeat(e):""}function _e(){C&&(X==="map"?xr():X==="level"?Mr():Tr())}function xr(){const e=[{lang:"ru",title:s("k.block.ru"),levels:fe.filter(r=>r.lang==="ru")},{lang:"en",title:s("k.block.en"),levels:fe.filter(r=>r.lang==="en")}],t=kt>0&&kt%3===0?`<div class="k-rest">${s("k.rest")}</div>`:"";C.innerHTML=`
    <div class="wrap kids">
      ...
      ${e.map(r=>`
        ...
        <div class="k-map">
          ${r.levels.map(a=>{const o=pr(a.id),i=ke.stars[a.id]??0;return`<button class="k-lvl ${o?"open":"locked"} ${i>0?"passed":""}" data-level="${a.id}" ${o?"":"disabled"}>
              <span class="k-num">${o?a.id:"🔒"}</span>
              <span class="k-stars">${wr(i)}</span>
            </button>`}).join("")}
        </div>`).join("")}
    </div>`,C.querySelectorAll("[data-level]").forEach(r=>{r.onclick=()=>{const a=fe.find(o=>o.id===Number(r.dataset.level));a&&yt(a)}}),C.querySelector("#k-exit").onclick=()=>Ue==null?void 0:Ue();const n=C.querySelector("#k-ai");n&&(n.onclick=()=>Me==null?void 0:Me())}function Sr(){let e="";for(let t=0;t<M.pattern.length;t++){const n=M.marks[t],r=t===M.pos?"cur":n===A.CORRECT?"ok":n===A.WRONG?"bad":"pend";e+=`<span class="${r}">${gn(M.pattern[t])}</span>`}return e}function Mr(){const e=F,t=M.finishedAt===null?M.pattern[M.pos]??null:null,n=O()==="ru"||e.lang==="ru";C.innerHTML=`
    <div class="wrap kids">
      <header class="k-head">
      ...
      <div class="k-word">${Sr()}</div>
      <div class="keyb">${qe(t,e.lang==="ru",n)}</div>
    </div>`,C.querySelector("#k-back").onclick=()=>{X="map",_e()}}function Tr(){const e=F;C.innerHTML=`
    <div class="wrap kids">
      <div class="k-done">
    ...
    </div>`,C.querySelector("#k-again").onclick=()=>yt(e),C.querySelector("#k-map2").onclick=()=>{X="map",_e()};const t=C.querySelector("#k-next");t&&(t.onclick=()=>{const n=fe.find(r=>r.id===e.id+1);n&&yt(n)})}const kn="tr_keystats";let ye=Er();function Er(){try{const e=JSON.parse(localStorage.getItem(kn)??"{}");return e&&typeof e=="object"?e:{}}catch{return{}}}let ht=null;function Ar(){ht||(ht=window.setTimeout(()=>{ht=null;try{localStorage.setItem(kn,JSON.stringify(ye))}catch{}},800))}function dt(e,t){const n=ye[e]??(ye[e]={ok:0,err:0});t?n.ok++:n.err++,Ar()}function yn(e=6){const t={};for(const[n,r]of Object.entries(ye)){const a=r.ok+r.err;a>=e&&(t[n]=r.err/a)}return t}function $n(e=6){return Object.values(ye).some(t=>t.ok+t.err>=e)}function Ir(e,t=6){return Et(e).map(({id:a,ch:o})=>{const i=ye[a],d=i?i.ok+i.err:0,l=d>=3?i.err/d:0;return{ch:o,rate:l,n:d}}).filter(a=>a.rate>0).sort((a,o)=>o.rate-a.rate||o.n-a.n).slice(0,t).map(a=>a.ch)}function Vt(e,t=6){const n=yn(4),r={};for(const{id:a,ch:o}of Et(e)){const i=n[a];i!==void 0&&i>0&&(r[o]=1+i*t)}return r}function Lr(e,t=5){let n=Ir(e,6);const r=e==="en"?["a","s","d","f","j","k","l"]:["ф","ы","в","а","о","л","д"];n.length===0&&(n=r.slice(0,4));const a=[...n,...n,...r],o=()=>a[Math.floor(Math.random()*a.length)],i=[];for(let d=0;d<t;d++){const l=[];for(let p=0;p<6;p++){const u=3+Math.floor(Math.random()*3);let m="";for(let j=0;j<u;j++)m+=o();l.push(m)}i.push(l.join(" "))}return i}const $t="tr_history";function De(e,t,n){if(e<=0)return;let r=[];try{r=JSON.parse(localStorage.getItem($t)??"[]")}catch{r=[]}Array.isArray(r)||(r=[]),r.push({t:n,wpm:e,acc:t}),r.length>300&&(r=r.slice(r.length-300));try{localStorage.setItem($t,JSON.stringify(r))}catch{}}function vt(){try{const e=JSON.parse(localStorage.getItem($t)??"[]");return Array.isArray(e)?e:[]}catch{return[]}}function Rr(e){const t=vt();if(!t.length)return 0;const n=new Set(t.map(i=>Math.floor(i.t/864e5)));let a=Math.floor(e/864e5);if(!n.has(a))if(n.has(a-1))a-=1;else return 0;let o=0;for(;n.has(a);)o++,a-=1;return o}function Pr(e=40){const t=vt().slice(-e);if(t.length<2)return"";const n=600,r=120,a=8,o=t.map(N=>N.wpm),i=Math.max(...o),d=Math.min(...o),l=i-d||1,p=N=>a+N/(t.length-1)*(n-2*a),u=N=>r-a-(N-d)/l*(r-2*a),m=t.map((N,Z)=>`${Z===0?"M":"L"} ${p(Z).toFixed(1)} ${u(N.wpm).toFixed(1)}`).join(" "),j=`${m} L ${p(t.length-1).toFixed(1)} ${r-a} L ${p(0).toFixed(1)} ${r-a} Z`,de=Math.max(...o),Y=o[o.length-1];return`<svg class="spark" viewBox="0 0 ${n} ${r}" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
    <path d="${j}" class="spark-area"/>
    <path d="${m}" class="spark-line"/>
    <circle cx="${p(t.length-1).toFixed(1)}" cy="${u(Y).toFixed(1)}" r="4" class="spark-dot"/>
  </svg>
  <div class="spark-meta"><span>сессий: <b>${vt().length}</b></span><span>макс: <b>${de}</b></span><span>последняя: <b>${Y}</b> WPM</span></div>`}const Or={en:["fj","dk","sl","a","ei","gh","ru","ty","wo","qp","vn","zxcb","m"],ru:["ао","вл","ыд","фж","пр","ен","кг","уш","цщ","йз","яч","смит","ьбюхэъ"]},jr={en:"the and you that was for are with his they have this from word what time work first water been call who now find long down day did get come made may part over new sound take only little place year live back give most very after thing our just name good through",ru:"и в не на что тот быть это как она для его так вот мочь сказать год этот рука дело глаз жизнь день есть знать самый раз время слово место друг два дом стать первый вода идти большой ещё свой"},Nr={en:["The quick brown fox jumps over the lazy dog.","Pack my box with five dozen liquor jugs.","How vexingly quick daft zebras jump.","The five boxing wizards jump quickly.","Sphinx of black quartz, judge my vow."],ru:["Съешь же ещё этих мягких французских булок да выпей чаю.","В чащах юга жил бы цитрус? Да, но фальшивый экземпляр!","Широкая электрификация южных губерний даст мощный толчок.","Эх, чужак, общий съём цен шляп юфти вдрызг!","Любя, съешь щипцы, — вздохнёт мэр, — кайф жгуч."]};function Cr(e){const t=[];let n=1,r="";Or[e].forEach((o,i)=>{if(r+=o,i===0){t.push({id:n++,kind:"home",newKeys:o,pool:o,titleKey:"course.home"});return}t.push({id:n++,kind:"keys",newKeys:o,pool:r,titleKey:"course.keys",titleArg:o.toUpperCase().split("").join(" ")}),o===(e==="en"?"a":"фж")&&t.push({id:n++,kind:"home",newKeys:"",pool:r,titleKey:"course.review"})});const a=r;return t.push({id:n++,kind:"caps",newKeys:"",pool:a,titleKey:"course.caps"}),t.push({id:n++,kind:"digits",newKeys:"0123456789",pool:"0123456789",titleKey:"course.digits"}),t.push({id:n++,kind:"punct",newKeys:"",pool:a,titleKey:"course.punct"}),t.push({id:n++,kind:"words",newKeys:"",pool:"",titleKey:"course.words"}),t.push({id:n++,kind:"sentences",newKeys:"",pool:"",titleKey:"course.sentences"}),t}const $e=e=>Math.floor(Math.random()*e);function Pt(e,t,n=5){const r=(e||"asdf").split(""),a=t?[...r,...t.split(""),...t.split("")]:r,o=[];for(let i=0;i<n;i++){const d=[];for(let l=0;l<6;l++){const p=3+$e(3);let u="";for(let m=0;m<p;m++)u+=a[$e(a.length)];d.push(u)}o.push(d.join(" "))}return o}function qr(e=5){const t=[];for(let n=0;n<e;n++){const r=[];for(let a=0;a<6;a++){let o="";for(let i=0;i<3+$e(2);i++)o+=String($e(10));r.push(o)}t.push(r.join(" "))}return t}function _r(e,t=4){const n=[",",".","?","!",";",":"];return Pt(e,"",t).map(a=>a.split(" ").map(o=>o+n[$e(n.length)]).join(" "))}function Dr(e,t=5){const n=jr[e].split(/\s+/),r=[];for(let a=0;a<t;a++){const o=[];for(let i=0;i<6;i++)o.push(n[$e(n.length)]);r.push(o.join(" "))}return r}function Hr(e,t=4){return Pt(e,"",t).map(n=>n.split(" ").map(r=>r.charAt(0).toUpperCase()+r.slice(1)).join(" "))}function Wr(e,t){switch(t.kind){case"digits":return qr();case"punct":return _r(t.pool);case"words":return Dr(e);case"sentences":return Nr[e];case"caps":return Hr(t.pool);default:return Pt(t.pool,t.newKeys)}}let z={stars:{}},Ee="en",Ae=[];function Br(){Ee=O()==="ru"?"ru":"en",Ae=Cr(Ee);try{const e=JSON.parse(localStorage.getItem(`tr_course_${Ee}`)??"");e&&e.stars?z=e:z={stars:{}}}catch{z={stars:{}}}}function Kr(){try{localStorage.setItem(`tr_course_${Ee}`,JSON.stringify(z))}catch{}}function Gr(e){return e===1||(z.stars[e-1]??0)>0}let Q="map",ue=null,Oe=[],Ie=0,y=w([""]),et=0,Ot=0,ae=0,D=null,Je=null;function Fr(e,t){D=e,Je=t,Br(),Q="map",He()}function zr(e){if(Q!=="lesson"||!ue||y.finishedAt!==null)return;if(e.key==="Backspace"){e.preventDefault();return}let t=null;if(e.key==="Enter"?t=`
`:e.key.length===1&&(t=e.key),t===null)return;e.preventDefault();const n=y.pattern[y.pos]??"";t=Ce(t,n);const r=/[а-яё]/i.test(y.pattern),a=ge(y,t,!0);if(n&&n!==" "&&n!==`
`){const o=ut(n,r);o&&dt(o,!a.wrong)}a.wrong&&et++,a.finished&&(Ot+=y.pattern.length,Ie+1<Oe.length?(Ie++,y=w([Oe[Ie]])):Ur()),He()}function Ur(){if(!ue)return;const e=U(y);ae=et===0?3:1-et/Math.max(Ot,1)>=.92?2:1,ae>(z.stars[ue.id]??0)&&(z.stars[ue.id]=ae,Kr()),e.wpm>0&&De(e.wpm,e.accuracy,Date.now()),Q="done"}function wt(e){ue=e,Ie=0,et=0,Ot=0,Oe=Wr(Ee,e),y=w([Oe[0]]),Q="lesson",He()}const jt=e=>e.replace(/[&<>"]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;"})[t]),vn=e=>e.titleArg?`${s(e.titleKey)}: ${e.titleArg}`:s(e.titleKey);function He(){D&&(Q==="map"?Jr():Q==="lesson"?Zr():Vr())}function Jr(){const e=Object.values(z.stars).filter(t=>t>0).length;D.innerHTML=`
    <div class="wrap course">
      ...
      <div class="c-map">
        ${Ae.map(t=>{const n=Gr(t.id),r=z.stars[t.id]??0;return`<button class="c-les ${n?"open":"locked"} ${r>0?"passed":""}" data-les="${t.id}" ${n?"":"disabled"}>
            <span class="c-num">${n?t.id:"🔒"}</span>
            <span class="c-name">${jt(vn(t))}</span>
            <span class="c-stars">${r>0?"⭐".repeat(r):""}</span>
          </button>`}).join("")}
      </div>
    </div>`,D.querySelectorAll("[data-les]").forEach(t=>{t.onclick=()=>{const n=Ae.find(r=>r.id===Number(t.dataset.les));n&&wt(n)}}),D.querySelector("#c-exit").onclick=()=>Je==null?void 0:Je()}function Yr(){let e="";for(let t=0;t<y.pattern.length;t++){const n=y.marks[t],r=t===y.pos?"cur":n===A.CORRECT?"ok":n===A.WRONG?"bad":"pend",a=y.pattern[t];a===`
`?e+=`<span class="${r} nl">↵</span><br/>`:e+=`<span class="${r}">${jt(a)}</span>`}return e}function Zr(){const e=ue,t=/[а-яё]/i.test(y.pattern),n=O()==="ru"||t,r=U(y);D.innerHTML=`
    <div class="wrap course">
      <header class="c-head">
      ...
      <div class="card"><div class="pattern" id="pattern">${Yr()}</div></div>
      <div class="keyb">${qe(y.finishedAt===null?y.pattern[y.pos]??null:null,t,n)}</div>
      <p class="hint2">${s("course.tip")}</p>
    </div>`,D.querySelector("#c-back").onclick=()=>{Q="map",He()}}function Vr(){const e=ue,t=Ae.find(r=>r.id===e.id+1);D.innerHTML=`
    <div class="wrap course">
      <div class="c-done">
...
`;let xt=null,Xt=null;function ss(e){xt&&Xt===e||(xt=Qr(e==="ru"?ns:rs,e,3),Xt=e)}let g=Nt();function Nt(){return{correct:0,keys:0,errors:0,ms:0,intervals:[],lines:0}}let T=w([""]),St=0,Ye=0,Le="m",tt="both",he=null,Ze=null;function as(){return O()==="ru"?"ru":"en"}function os(){const e=as(),t=Le==="kids"?24:Le==="f"?40:50,n=Le==="kids"?5:8;if(tt==="both")return ss(e),ts(xt,{chars:t,weight:Vt(e),maxWord:n});const r=Vt(e),a=[];for(const d of Xn(e,tt)){const l=Math.max(1,Math.round(r[d]??1));for(let p=0;p<l;p++)a.push(d)}if(a.length===0)return"";const o=[];let i=0;for(;o.join(" ").length<t&&i++<60;){const d=3+Math.floor(Math.random()*(n-2));let l="";for(let p=0;p<d;p++)l+=a[Math.floor(Math.random()*a.length)];o.push(l)}return o.join(" ")}function Ct(){T=w([os()]),St=0,Ye=0}function is(e,t,n){he=e,Ze=n,Le=t,g=Nt(),Ct(),qt()}function ls(){const e=wn();e.mastery>0&&De(Math.round(e.mastery/5),e.accuracy,Date.now()),Ze==null||Ze()}function cs(e){if(!he)return;if(e.key==="Backspace"){e.preventDefault();return}let t=null;if(e.key==="Enter"?t=`
`:e.key.length===1&&(t=e.key),t===null)return;e.preventDefault();const n=Date.now();T.startedAt===null&&(St=n,Ye=n);const r=T.pattern[T.pos]??"";t=Ce(t,r);const a=/[а-яё]/i.test(T.pattern),o=ge(T,t,!0);if(o.accepted){const i=n-Ye;i>0&&i<3e3&&g.intervals.push(i),Ye=n,g.keys++,r!==" "&&r!==`
`&&g.correct++}if(r&&r!==" "&&r!==`
`){const i=ut(r,a);i&&dt(i,!o.wrong)}o.wrong&&g.errors++,o.finished&&(g.ms+=n-St,g.lines++,Ct()),qt()}function wn(){const e=g.ms/6e4,t=e>0?Math.round(g.correct/e):0,n=e>0?Math.round((g.correct+g.errors)/e):0,r=g.correct+g.errors,a=r>0?Math.round(g.correct/r*100):100;let o=0;if(g.intervals.length>=4){const i=g.intervals.reduce((p,u)=>p+u,0)/g.intervals.length,d=g.intervals.reduce((p,u)=>p+(u-i)**2,0)/g.intervals.length,l=Math.sqrt(d)/(i||1);o=Math.max(0,Math.min(100,Math.round((1-l)*100)))}return{mastery:t,tempo:n,rhythm:o,accuracy:a}}const us=e=>e.replace(/[&<>"]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;"})[t]);function ds(){let e="";for(let t=0;t<T.pattern.length;t++){const n=T.marks[t],r=t===T.pos?"cur":n===A.CORRECT?"ok":n===A.WRONG?"bad":"pend";e+=`<span class="${r}">${us(T.pattern[t])}</span>`}return e}function ps(e){return e>=300?s("learn.lvl.pro"):e>=200?s("learn.lvl.work"):e>=70?s("learn.lvl.good"):s("learn.lvl.start")}function qt(){if(!he)return;const e=wn(),t=/[а-яё]/i.test(T.pattern),n=O()==="ru"||t,r=Le==="kids";he.innerHTML=`
    <div class="wrap learn">
      ...
      <div class="card"><div class="pattern" id="pattern">${ds()}</div></div>
      <div class="keyb">${qe(T.finishedAt===null?T.pattern[T.pos]??null:null,t,n)}</div>
      ${r?`
      ...
      `:`
        <div class="statsbar learn-stats">
          <div><b>${e.mastery}</b><span>${s("learn.mastery")}</span><i>${ps(e.mastery)}</i></div>
      ...
      `}
    </div>`,he.querySelector("#ai-exit").onclick=()=>ls(),he.querySelectorAll("[data-hand]").forEach(a=>{a.onclick=()=>{tt=a.dataset.hand,g=Nt(),Ct(),qt()}})}const xn="https://iuvvheeocobhiothfgei.supabase.co",Qt="sb_publishable_A2vJ5DjemTZIKrKX6XGqvQ_WaiuAkk1",Sn="typing_leaderboard",Mn={apikey:Qt,Authorization:`Bearer ${Qt}`,"Content-Type":"application/json"};async function hs(e){try{return(await fetch(`${xn}/rest/v1/${Sn}`,{method:"POST",headers:{...Mn,Prefer:"return=minimal"},body:JSON.stringify(e)})).ok}catch{return!1}}async function fs(e,t,n=10){try{const r=`discipline=eq.${e}&lang=eq.${t}&order=wpm.desc&limit=${n}`,a=await fetch(`${xn}/rest/v1/${Sn}?${r}`,{headers:Mn});return a.ok?await a.json():[]}catch{return[]}}const ms=["alpha_fwd","alpha_rev","words","digits","sprint"],en={en:"abcdefghijklmnopqrstuvwxyz",ru:"абвгдежзийклмнопрстуфхцчшщъыьэюя"},bs={en:"time year people way day man thing woman life child world school state family student group country problem hand part place case week company system program work",ru:"время год человек дело жизнь день рука работа слово место вопрос сторона страна мир случай ребёнок голова система вода друг земля город конец час глаз"},tn={en:["the quick brown fox jumps","practice makes perfect every day","never stop learning new things","small steps lead to big wins"],ru:["тише едешь дальше будешь","практика путь к мастерству","учись каждый день понемногу","терпение и труд всё перетрут"]},ft=e=>Math.floor(Math.random()*e);function gs(e,t){if(e==="alpha_fwd")return en[t];if(e==="alpha_rev")return en[t].split("").reverse().join("");if(e==="digits"){let n="";for(let r=0;r<30;r++)n+=String(ft(10))+(r%5===4?" ":"");return n.trim()}if(e==="words"){const n=bs[t].split(/\s+/),r=[];for(let a=0;a<12;a++)r.push(n[ft(n.length)]);return r.join(" ")}return tn[t][ft(tn[t].length)]}let ve={};function ks(){try{ve=JSON.parse(localStorage.getItem("tr_compete")??"{}")||{}}catch{ve={}}}function ys(){try{localStorage.setItem("tr_compete",JSON.stringify(ve))}catch{}}const Tn=(e,t)=>`${e}_${t}`;let H="menu",ee="alpha_fwd",x=w([""]),nt=0,_t=0,ie=null,En="m",S=null,Ve=null,rt=[],Mt=!1,je=!1;function we(){return O()==="ru"?"ru":"en"}function $s(e,t,n){S=e,Ve=n,En=t,ks(),H="menu",te()}function An(e){ee=e,_t=0,nt=0,je=!1,x=w([gs(e,we())]),H="run",te()}function vs(e){if(H!=="run"||x.finishedAt!==null)return;if(e.key==="Backspace"){e.preventDefault();return}let t=null;if(e.key==="Enter"?t=`
`:e.key.length===1&&(t=e.key),t===null)return;e.preventDefault(),nt===0&&(nt=Date.now());const n=x.pattern[x.pos]??"";t=Ce(t,n);const r=/[а-яё]/i.test(x.pattern),a=ge(x,t,!0);if(n&&n!==" "&&n!==`
`){const o=ut(n,r);o&&dt(o,!a.wrong)}a.wrong&&_t++,a.finished&&ws(),te()}function ws(){U(x);const e=Date.now()-nt,t=e/6e4,n=x.pattern.replace(/\s/g,"").length,r=t>0?Math.round(n/5/t):0,a=n+_t,o=a>0?Math.round(n/a*100):100,i=o===100?r>=60?"🥇":r>=40?"🥈":"🥉":r>=50&&o>=95?"🥈":"🎖",d=Tn(ee,we()),l=r>(ve[d]??0)&&o>=90;l&&(ve[d]=r,ys()),De(r,o,Date.now()),ie={wpm:r,acc:o,ms:e,medal:i,isRecord:l},H="result"}async function In(){H="board",Mt=!0,rt=[],te(),rt=await fs(ee,we()),Mt=!1,te()}async function xs(e){if(!(!ie||je)){je=!0;try{localStorage.setItem("tr_name",e)}catch{}await hs({name:e,discipline:ee,lang:we(),wpm:ie.wpm,accuracy:ie.acc,ms:ie.ms}),await In()}}const Dt=e=>e.replace(/[&<>"]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;"})[t]);function Ss(){let e="";for(let t=0;t<x.pattern.length;t++){const n=x.marks[t],r=t===x.pos?"cur":n===A.CORRECT?"ok":n===A.WRONG?"bad":"pend";e+=`<span class="${r}">${Dt(x.pattern[t])}</span>`}return e}function te(){S&&(H==="menu"?Ms():H==="run"?Ts():H==="result"?Es():As())}function Ms(){const e=we();S.innerHTML=`
    <div class="wrap compete">
      ...
      <div class="cp-grid">
        ${ms.map(t=>{const n=ve[Tn(t,e)]??0;return`<button class="cp-disc" data-d="${t}">
            <span class="cp-name">${s("comp."+t)}</span>
            <span class="cp-best">${n>0?`${s("comp.best")}: ${n} ${s("st.wpm")}`:"—"}</span>
          </button>`}).join("")}
      </div>
    </div>`,S.querySelectorAll("[data-d]").forEach(t=>{t.onclick=()=>An(t.dataset.d)}),S.querySelector("#cp-exit").onclick=()=>Ve==null?void 0:Ve()}function Ts(){const e=/[а-яё]/i.test(x.pattern),t=O()==="ru"||e;S.innerHTML=`
    <div class="wrap compete">
      <header class="c-head">
      ...
      <div class="card"><div class="pattern pattern-big" id="pattern">${Ss()}</div></div>
      <div class="keyb">${qe(x.finishedAt===null?x.pattern[x.pos]??null:null,e,t)}</div>
    </div>`,S.querySelector("#cp-back").onclick=()=>{H="menu",te()}}function Es(){const e=ie,t=localStorage.getItem("tr_name")??"",n=En==="kids";S.innerHTML=`
    <div class="wrap compete">
      <div class="cp-result">
    ...
    </div>`,S.querySelector("#cp-again").onclick=()=>An(ee),S.querySelector("#cp-menu").onclick=()=>{H="menu",te()},S.querySelector("#cp-board").onclick=()=>In();const r=S.querySelector("#cp-pub");r&&(r.onclick=()=>xs(S.querySelector("#cp-name").value.trim()||"—"))}function As(){const e=we();S.innerHTML=`
    <div class="wrap compete">
      <header class="c-head">
    ...
    </div>`,S.querySelector("#cp-bback").onclick=()=>{H=ie?"result":"menu",te()}}let L=er(),Ht=[],ne="abandon",E=[],$=0,f=w([""]),st=!1,Wt=!0,Ne=!0,Bt=!0,at=localStorage.getItem("tr_heat")==="1",be=(()=>{const e=localStorage.getItem("tr_dark");return e==="1"?!0:e==="0"?!1:!!(window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches)})(),k=null,b=null,Kt="",P=null,W=localStorage.getItem("tr_flow")==="1",G={typed:0,errors:0,ms:0,count:0};function Is(){G={typed:0,errors:0,ms:0,count:0}}let c=null;function ot(){const e=c&&c.phase==="run"?U(f):{typed:0,errors:0},t=((c==null?void 0:c.typed)??0)+e.typed,n=((c==null?void 0:c.errors)??0)+e.errors,r=c?c.durMin*6e4-Math.max(0,c.endAt-Date.now()):0,a=Math.max(r/6e4,1/600),o=Math.round((t+n)/5/a),i=Math.round(t/5/a),d=t+n,l=d>0?Math.round(t/d*100):100;return{typed:t,errors:n,gross:o,net:i,accuracy:l,elapsedMs:r}}function Ls(e,t,n){const a=[...on(Ht,"abandon")].sort(()=>Math.random()-.5);c={phase:"run",durMin:e,target:t,name:n,endAt:Date.now()+e*6e4,typed:0,errors:0,count:0,pool:a,pi:0,timer:null};try{localStorage.setItem("tr_name",n)}catch{}f=w([a[0].lines.join(" ")]),c.timer=window.setInterval(()=>{if(!(!c||c.phase!=="run")){if(Date.now()>=c.endAt){Ln();return}qs()}},250),h()}function Ln(){if(!c)return;const e=U(f);c.typed+=e.typed,c.errors+=e.errors,c.timer&&(clearInterval(c.timer),c.timer=null),c.phase="result";const t=ot();De(t.net,t.accuracy,Date.now()),h()}function nn(){c!=null&&c.timer&&clearInterval(c.timer),c=null,se()}let v={bestWpm:0,bestAcc:0,done:[],lastIdx:0};function Rs(e){try{const t=JSON.parse(localStorage.getItem(`tr_progress_${e}`)??"");if(t&&Array.isArray(t.done))return{bestWpm:t.bestWpm|0,bestAcc:t.bestAcc|0,done:t.done,lastIdx:t.lastIdx|0}}catch{}return{bestWpm:0,bestAcc:0,done:[],lastIdx:0}}function Gt(){try{localStorage.setItem(`tr_progress_${ne}`,JSON.stringify(v))}catch{}}function Ps(e){const t=U(f);t.wpm>v.bestWpm&&(v.bestWpm=t.wpm),t.accuracy>v.bestAcc&&(v.bestAcc=t.accuracy),v.done.includes(e.id)||v.done.push(e.id),Gt()}function Rn(){const e=U(f);if(!W)return e;const t=G.typed+e.typed,n=G.errors+e.errors,r=G.ms+e.elapsedMs,a=r/6e4,o=a>0?Math.round(t/5/a):0,i=t+n;return{typed:t,errors:n,elapsedMs:r,wpm:o,accuracy:i>0?Math.round(t/i*100):100}}let xe=null;function rn(){if(Wt)try{xe??(xe=new AudioContext);const e=xe.createOscillator(),t=xe.createGain();e.frequency.value=220,e.type="square",t.gain.value=.06,e.connect(t),t.connect(xe.destination),e.start(),e.stop(xe.currentTime+.07)}catch{}}const R=document.getElementById("app");let pe=!1,it=!1,Ke=!1,Re=!1,Ge=!1,lt=!1,Fe=!1,Ft=!0,Tt=!1;function Pn(){return/[а-яё]/i.test(f.pattern)}function Os(e){return O()==="ru"||e}function On(){be?document.documentElement.dataset.theme="dark":delete document.documentElement.dataset.theme}function jn(){return`<select id="lang" title="Language">
    <option value="ru" ${O()==="ru"?"selected":""}>RU</option>
    <option value="en" ${O()==="en"?"selected":""}>EN</option>
  </select>`}function Nn(e){const t=document.getElementById("lang");t&&(t.onchange=()=>{tr(t.value),e()})}function js(){return b==="weak"?{id:"weak",bank:ne,title:s("weak.title"),lines:Pe}:b==="custom"?{id:"custom",bank:ne,title:s("custom.title"),lines:le}:E[$]??null}let Pe=[],le=[];function h(){if(L===null){pe=!1,Wn();return}if(Re){Ge||(Ge=!0,is(R,L??"m",()=>{Re=!1,Ge=!1,h()}));return}if(Ge=!1,lt){Fe||(Fe=!0,$s(R,L??"m",()=>{lt=!1,Fe=!1,h()}));return}if(Fe=!1,L==="kids"){pe||(pe=!0,yr(R,()=>{pe=!1,L=null,At(null),h()},()=>{pe=!1,Re=!0,h()}));return}if(pe=!1,it){Ke||(Ke=!0,Fr(R,()=>{it=!1,Ke=!1,h()}));return}if(Ke=!1,c){Cs();return}if(Ft){Ws();return}const e=js(),t=Rn(),n=b!==null;R.innerHTML=`
    <div class="wrap">
      <header>
      ...
      <p class="bankdesc">${n?b==="weak"?s("weak.hint"):"":s("bank."+ne+".desc")} ${n?"":`· <b>${E.length}</b> ${s("st.exercises")} · ${s("st.done")} <b>${v.done.length}</b>${v.bestWpm>0?` · ${s("st.record")} <b>${v.bestWpm}</b> ${s("st.wpm")} · <b>${v.bestAcc}%</b>`:""}`}</p>
      ...
      ${Tt?`<div class="toolbar settings-panel">
        ...
        <label><input type="checkbox" id="block" ${Ne?"checked":""}/> ${s("tb.block")}</label>
      ...
      <div class="nav-row">
        ...
        <span class="counter">${n?"•":`${$+1} / ${E.length}`}</span>
      ...
      ${f.finishedAt!==null?Ns(t):`<p class="hint2">${b==="weak"&&Pe.length&&Cn?s("weak.none"):s(W?"hint.flow":"hint.type")} ${s(Ne?"hint.block":"hint.bs")}</p>`}
    </div>
    ${P?Hn():""}
  `,Hs()}let Cn=!1;function qn(){if(!Bt)return"";const e=Pn(),t=at&&$n()?yn():null;return`<div class="keyb">${qe(f.finishedAt===null?f.pattern[f.pos]??null:null,e,Os(e),t)}</div>
    ...
    ${W?`<div><b>🔥 ${G.count}</b><span>${s("st.streak")}</span></div>`:""}`}function J(e){return e.replace(/[&<>"]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;"})[t])}function Dn(){if(st)return`<span class="hidden-note">${s("hint.hidden")}</span>`;let e="";for(let t=0;t<f.pattern.length;t++){const n=f.pattern[t],r=f.marks[t],a=t===f.pos?"cur":r===A.CORRECT?"ok":r===A.WRONG?"bad":"pend";n===`
`?e+=`<span class="${a} nl">↵</span><br/>`:e+=`<span class="${a}">${J(n)}</span>`}return e}function Hn(){if(P==="custom")return`<div class="modal-bg" id="modal-bg"><div class="modal">
    ...
    </div>`,R.querySelectorAll("[data-profile-pick]").forEach(e=>{e.onclick=()=>{L=e.dataset.profilePick,mn(L),h()}}),Nn(()=>Wn())}function Ns(e){return`
    <div class="done">
      <h2>${s(L==="f"?"done.title.f":"done.title")}</h2>
      <div class="donestats">
    ...
    </div>`}function Cs(){if(!c)return;if(c.phase==="setup"){const n=localStorage.getItem("tr_name")??"";R.innerHTML=`
      ...
      </div></div>`,document.getElementById("ex-go").onclick=()=>{const r=Number(document.getElementById("ex-dur").value),a=Number(document.getElementById("ex-target").value)||35,o=document.getElementById("ex-name").value.trim();Ls(r,a,o)},document.getElementById("ex-cancel").onclick=()=>nn();return}if(c.phase==="run"){const n=c.pool[c.pi],r=ot();R.innerHTML=`
      <div class="wrap">
        <div class="exam-hud">
        ...
        ${qn()}
      </div>`,document.getElementById("ex-stop").onclick=()=>Ln();return}const e=ot(),t=e.net>=c.target;R.innerHTML=`
    ...
    </div></div>`,document.getElementById("ex-cert").onclick=()=>_s(e,t),document.getElementById("ex-retry").onclick=()=>{c.phase="setup",h()},document.getElementById("ex-exit").onclick=()=>nn()}function Bn(e){const t=Math.ceil(e/1e3);return`${Math.floor(t/60)}:${String(t%60).padStart(2,"0")}`}function qs(){if(!c||c.phase!=="run")return;const e=document.getElementById("ex-timer"),t=document.getElementById("ex-hudstats");if(!e||!t)return;const n=ot();e.textContent=Bn(Math.max(0,c.endAt-Date.now())),t.innerHTML=`${s("ex.net")} <b>${n.net}</b> · ${s("st.accuracy")} <b>${n.accuracy}%</b> · ${s("ex.target.short")} ${c.target}`}function _s(e,t){if(!c)return;const n=document.createElement("canvas");n.width=1200,n.height=850;const r=n.getContext("2d");r.fillStyle="#faf7f0",r.fillRect(0,0,1200,850),r.strokeStyle="#b9962e",r.lineWidth=6,r.strokeRect(30,30,1140,790),r.lineWidth=1.5,r.strokeRect(44,44,1112,762),r.fillStyle="#2a2a33",r.textAlign="center",r.font="700 28px Georgia, serif",r.fillText("TypeRIGHTing",600,110),r.font="800 64px Georgia, serif",r.fillStyle="#b9962e",r.fillText(s("ex.cert.title"),600,200),r.font="400 26px Georgia, serif",r.fillStyle="#555",r.fillText(s("ex.cert.sub"),600,240),r.font="700 52px Georgia, serif",r.fillStyle="#2a2a33",r.fillText(c.name||"—",600,350),r.font="800 110px Georgia, serif",r.fillStyle=t?"#2f7d4f":"#b3443a",r.fillText(`${e.net} ${s("ex.net")}`,600,500),r.font="400 30px Georgia, serif",r.fillStyle="#444",r.fillText(`${s("ex.gross")}: ${e.gross}   ·   ${s("st.accuracy")}: ${e.accuracy}%   ·   ${c.durMin} ${s("ex.min")}`,600,570),r.font="700 36px Georgia, serif",r.fillStyle=t?"#2f7d4f":"#b3443a",r.fillText(t?`✔ ${s("ex.pass")}`:`✘ ${s("ex.fail")}`,600,650),r.font="400 22px Georgia, serif",r.fillStyle="#777",r.fillText(`${s("ex.cert.date")}: ${new Date().toLocaleDateString()}`,600,740);const a=document.createElement("a");a.download=`TypeRIGHTing-test-${e.net}wpm.png`,a.href=n.toDataURL("image/png"),a.click()}function ct(){b="weak",c=null,Pe=Lr(O()==="ru"?"ru":"en"),Cn=!$n(3),f=w(W?[Pe.join(" ")]:Pe),k&&(clearInterval(k),k=null),h()}function sn(e){Kt=e,le=e.split(/\r?\n/).map(t=>t.trimEnd()).filter(t=>t.length>0),le.length!==0&&(b="custom",c=null,P=null,f=w(W?[le.join(" ")]:le),k&&(clearInterval(k),k=null),h())}function Ds(){b=null,zt()}function I(e,t){const n=document.getElementById(e);n&&(n.onclick=t)}function re(e,t){const n=document.getElementById(e);n&&(n.onchange=()=>t(n))}function Se(e){b=null,c=null,k&&(clearInterval(k),k=null),e(),h()}function Kn(){const e=document.getElementById("profile");e&&(e.onchange=()=>{L=e.value,mn(L),h()}),I("dark",()=>{be=!be;try{localStorage.setItem("tr_dark",be?"1":"0")}catch{}On(),h()}),Nn(()=>h())}function Hs(){Kn(),re("bank",t=>{b=null,ne=t.value,zt()}),I("home",()=>{Ft=!0,b=null,k&&(clearInterval(k),k=null),h()}),I("settings",()=>{Tt=!Tt,h()}),re("hide",t=>{st=t.checked,h()}),re("sound",t=>{Wt=t.checked}),re("block",t=>{Ne=t.checked}),re("keyb",t=>{Bt=t.checked,h()}),re("heat",t=>{at=t.checked;try{localStorage.setItem("tr_heat",at?"1":"0")}catch{}h()}),re("flow",t=>{W=t.checked;try{localStorage.setItem("tr_flow",W?"1":"0")}catch{}Is(),b?b==="weak"?ct():sn(Kt):se()}),I("weak",()=>{b==="weak"?Ds():ct()}),I("custom",()=>{P="custom",h()}),I("prev",()=>{if(b){ze();return}$=($-1+E.length)%E.length,se()}),I("next",()=>{if(b){ze();return}$=($+1)%E.length,se()}),I("again",()=>{b?ze(!0):se()}),I("nextdone",()=>{if(b){ze();return}$=($+1)%E.length,se()});const e=document.getElementById("modal-bg");e&&(e.onclick=t=>{t.target===e&&(P=null,h())}),I("custom-go",()=>sn(document.getElementById("custom-ta").value)),I("custom-cancel",()=>{P=null,h()}),I("prog-close",()=>{P=null,h()})}function Ws(){const e=Rr(Date.now()),t=[["train","⌨️",s("hub.train"),s("hub.train.d")],["course","📚",s("course.title"),s("hub.course.d")],["learn","🤖",s("learn.title"),s("hub.learn.d")],["compete","🏆",s("compete.title"),s("hub.compete.d")],["exam","⏱",s("ex.title"),s("hub.exam.d")],["progress","📈",s("prog.title"),s("hub.progress.d")]];R.innerHTML=`
    <div class="wrap hub">
      <header>
        <h1>Type<span>RIGHT</span>ing</h1>
        <div class="headctl">
          <select id="profile" title="Profile">
            ${Object.keys(Qe).map(r=>`<option value="${r}" ${r===L?"selected":""}>${Qe[r]} ${s("profile."+r)}</option>`).join("")}
          </select>
          <button id="dark" class="iconbtn" title="${s("tb.dark")}">${be?"☀️":"🌙"}</button>
          ${jn()}
        </div>
    ...
    ${P?Hn():""}`,Kn(),R.querySelectorAll("[data-go]").forEach(r=>{r.onclick=()=>{const a=r.dataset.go;a==="train"?Se(()=>{Ft=!1}):a==="course"?Se(()=>{it=!0}):a==="learn"?Se(()=>{Re=!0}):a==="compete"?Se(()=>{lt=!0}):a==="exam"?Se(()=>{c={phase:"setup",durMin:10,target:35,name:"",endAt:0,typed:0,errors:0,count:0,pool:[],pi:0,timer:null}}):a==="progress"&&(P="progress",h())}});const n=document.getElementById("modal-bg");n&&(n.onclick=r=>{r.target===n&&(P=null,h())}),I("prog-close",()=>{P=null,h()})}function ze(e=!1){if(b==="weak"&&!e){ct();return}if(b==="weak"){ct();return}f=w(W?[le.join(" ")]:le),h()}function zt(){E=on(Ht,ne),v=Rs(ne),$=Math.min(Math.max(v.lastIdx,0),Math.max(E.length-1,0)),se()}function Gn(e){return w(e?W?[e.lines.join(" ")]:e.lines:[""])}function se(){f=Gn(E[$]),k&&(clearInterval(k),k=null),v.lastIdx!==$&&(v.lastIdx=$,Gt()),h()}document.addEventListener("keydown",e=>{var i;const t=(i=e.target)==null?void 0:i.tagName;if(t==="SELECT"||t==="INPUT"||t==="TEXTAREA")return;if(P){e.key==="Escape"&&(P=null,h());return}if(it){zr(e);return}if(Re){cs(e);return}if(lt){vs(e);return}if(L==="kids"){$r(e);return}if(c&&c.phase!=="run"||f.finishedAt!==null)return;if(e.key==="Backspace"){e.preventDefault(),(c||!Ne)&&(Yn(f),h());return}let n=null;if(e.key==="Enter"?n=`
`:e.key.length===1&&(n=e.key),n===null)return;e.preventDefault();const r=f.pattern[f.pos]??"";n=Ce(n,r);const a=Pn();if(c){const d=ge(f,n,!1);if(an(r,d.wrong,a),d.wrong&&rn(),d.finished){const l=U(f);c.typed+=l.typed,c.errors+=l.errors,c.count++,c.pi=(c.pi+1)%c.pool.length,f=w([c.pool[c.pi].lines.join(" ")])}h();return}f.startedAt===null&&!k&&(k=window.setInterval(()=>{f.finishedAt===null&&Bs()},250));const o=ge(f,n,Ne);if(an(r,o.wrong,a),o.wrong&&rn(),o.finished){const d=U(f);if(W&&!b){const l=E[$];G.typed+=d.typed,G.errors+=d.errors,G.ms+=d.elapsedMs,G.count++,l&&!v.done.includes(l.id)&&v.done.push(l.id),$=($+1)%E.length,v.lastIdx=$,Gt(),f=Gn(E[$])}else if(k&&(clearInterval(k),k=null),De(d.wpm,d.accuracy,Date.now()),!b){const l=E[$];l&&Ps(l)}}h()});function an(e,t,n){if(!e||e===`
`||e===" ")return;const r=ut(e,n);r&&dt(r,!t)}function Bs(){const e=document.querySelector(".statsbar");e&&(e.innerHTML=_n(Rn()))}At(L);On();Jn().then(e=>{Ht=e,zt()}).catch(e=>{R.innerHTML=`<div class="wrap"><p class="err">${s("err.load")}: ${J(String(e))}</p></div>`});
